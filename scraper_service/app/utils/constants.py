...
BOOKS_WANT_TO_READ_COUNT_QUERY = "li.reading-log-stat:has(span.readers-stats__label:contains('Quiero leer')) span.readers-stats__stat"
BOOKS_READ_COUNT_QUERY = "li.reading-log-stat:has(span.readers-stats__label:contains('He leído')) span.readers-stats__stat"
BOOKS_CURRENTLY_READING_COUNT_QUERY = "li.reading-log-stat:has(span.readers-stats__label:contains('Actualmente leyendo')) span.readers-stats__stat"
BOOKS_WORKING_ID_QUERY = "dt:contains('Work ID') + dd"
